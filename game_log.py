...
class GameLog:
    def __init__(self, x, y, width, height, font: pygame.font.Font):
        self.x = x
        self.y = y
        self.width = width
        self.height = height
    ...
    def draw(self, window: pygame.Surface):
        ...
        for i, msg in enumerate(self.messages):
            y = self.padding + i * self.lineHeight - self._scrollY
...
log = GameLog(x=20, y=20, width=240, height=400, font=font)
